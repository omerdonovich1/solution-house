    ...
    <div className="liquid-glass relative grid grid-cols-[auto_1fr] gap-5 overflow-hidden rounded-3xl px-4 py-6 sm:gap-12 sm:px-7 sm:py-8">
      ...
      <div className="pb-2">
        ...
        <div className="mt-5 max-w-xl border-t border-white/[0.08] pt-4 sm:mt-7 sm:pt-5">
          <p className="text-[15px] leading-relaxed text-body">{tx(step.insight)}</p>
        </div>
      </div>
    </div>
  );
    ...
    <section id="process" className="py-16 sm:py-24">
      <div className="shell">
        <SectionHeader
          center
          index="02"
          title={tx({ he: "ארבעה שלבים. בלי הפתעות.", en: "Four steps. No surprises." })}
          lead={tx({
            he: "לא מתחייבים מראש על הכול. מתקדמים שלב אחר שלב — ואחרי כל שלב אתם מחליטים אם ממשיכים.",
            en: "No upfront commitment to everything. We move step by step — and after each one, you decide whether to continue.",
          })}
        />
