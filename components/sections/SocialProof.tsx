...
const TESTIMONIALS: readonly Testimonial[] = [
  {
    quote: "מערכת ניהול צי הרכב שינתה לנו את היום-יום — מעקב ידני באקסלים הפך למסך אחד. חסכנו עשרות שעות בחודש.",
    name: "מיכל א׳",
    role: "מנהלת תפעול, ניהול צי רכב",
  },
  {
    quote: "מערכת בקרת האיכות נתנה לנו שליטה מלאה על הייצור — בלי אקסלים ובלי ניחושים.",
    name: "רון ד׳",
    role: "מנהל איכות, חברת ייצור",
  },
  {
    quote: "האתר החדש מרגיש בדיוק כמו המותג שלנו — מהיר, נקי וממיר הרבה יותר.",
    name: "יעל כ׳",
    role: "בעלים, מותג איקומרס",
  },
  {
    quote: "סוכן ה-AI עונה לרוב הפניות לבד, מסביב לשעון — הלקוחות מרוצים יותר מאי פעם.",
    name: "אבי מ׳",
    role: "מנהל שירות לקוחות",
  },
];
