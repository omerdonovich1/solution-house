...
const CASES: readonly CaseStudy[] = [
  {
    client: "חברת לוגיסטיקה ישראלית",
    type: "מערכת ניהול צי רכב",
    challenge: "מעקב ידני אחרי עשרות רכבים באקסלים מפוזרים.",
    solution: "מערכת אחת שמרכזת מיקום, תחזוקה ומשימות בזמן אמת.",
    result: "חיסכון של 30 שעות שבועיות",
    metric: "30 ש׳/שבוע",
  },
  {
    client: "רשת מסעדות",
    type: "סוכן AI לשירות לקוחות",
    challenge: "מאות פניות חוזרות ביום שהעמיסו על הצוות.",
    solution: "סוכן AI שעונה, מזמין ומנתב — מסביב לשעון.",
    result: "90% מהפניות נענות אוטומטית",
    metric: "90% אוטומציה",
  },
  {
    client: "סטארטאפ פינטק",
    type: "דשבורד אנליטי",
    challenge: "נתונים קריטיים שהתגלו רק בסוף החודש.",
    solution: "דשבורד חי שמציג את המדדים החשובים בכל רגע.",
    result: "תובנות בזמן אמת, החלטות מהירות",
    metric: "נתונים בזמן אמת",
  },
];
