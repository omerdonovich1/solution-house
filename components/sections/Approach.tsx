    ...
    <section id="approach" className="py-32 sm:py-44">
      <div className="shell">
        <SectionHeader
          index="(01)"
          label="הגישה שלנו"
          title="הגישה — הנדסה שמתחילה מהביזנס, לא מהקוד."
          lead={
            <>
              אנחנו לא בונים פרויקטים –{" "}
              <strong className="font-semibold text-bright">
                אנחנו מהנדסים את התשתית להצלחה שלכם
              </strong>
              . הגישה שלנו משלבת הנדסת תוכנה ללא פשרות עם אסתטיקה שקובעת
              סטנדרטים, כדי להעניק לכם{" "}
              <strong className="font-semibold text-bright">
                יתרון תחרותי בשוק דינמי
              </strong>
              .
            </>
          }
