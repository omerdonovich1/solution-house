...
export const APPROACH: readonly ApproachColumn[] = [
  ...
  },
  {
    label: "אנחנו",
    title: "פותרים בעיות",
    body: "קודם כל מבינים את צורך השורש שלכם. רק לאחר מכן, אנחנו בונים את הפתרון המהיר, החכם והיעיל ביותר כדי לפתור את הבעיה מהיסוד.",
    winner: true,
  },
] as const;
...
export const STEPS: readonly ProcessStep[] = [
  {
    ...
    title: "מיפוי הכאב",
    description:
      "מקשיבים, מנתחים וממפים את הבעיה האמיתית. לא רק הסימפטומים, אלא כאב השורש שמונע מהעסק שלכם לצמוח.",
  ...
  },
  {
    ...
    title: "הגדרת יעדים",
    description:
      "מגדירים במדויק את המטרה. איך נראה פתרון שעובד? איך נמדוד הצלחה? זה המפתח להכל.",
    insight: "אם אתה לא יודע לאן אתה הולך, כל דרך שתוביל אליו תהיה שגויה.",
  },
  {
    index: "03",
    title: "פיתוח ממוקד",
    description:
      "בונים בדיוק את מה שצריך. ללא פיצ'רים מיותרים. המסלול הישיר לפתרון טכנולוגי שעובד.",
  ...
  },
  {
    ...
    title: "הוכחת ביצועים",
    description:
      "הפתרון עולה לאוויר ואנחנו מודדים אותו. עובד? משדרגים. לא מדויק מספיק? עושים אופטימיזציה מהירה. בלי דעות אישיות, רק על בסיס נתונים.",
...
export const PROJECTS: readonly Project[] = [
  ...
  },
  {
    id: "shadiez",
    name: "SHADIEZ",
    description: "מותג E-commerce. חוויית קנייה מהירה, נוחה ומוכוונת המרות, עטופה בעיצוב חכם ויוקרתי.",
  ...
  },
  {
    id: "spinz",
    name: "SPINZ",
    description: "מותג אופניים אורבניים. פלטפורמת אי-קומרס מתקדמת וייעודית לאופני סינגל-ספיד. תחנת הידע והרכישה המובילה.",
  ...
  },
  {
    ...
    name: "Project 4",
    description:
      "פרויקט ניסיוני נוסף שמדגים את יכולתנו בתחום. (תוכן זה צריך להתעדכן עם פרטים אמיתיים)",
...
export const TEAM: readonly TeamMember[] = [
  ...
  },
  {
    ...
    tag: "EXECUTION",
    value:
      "בונה את הפתרונות, לוקח את החזון ופותר כל אתגר טכני בדרך ברמת דיוק מקסימלית.",
  },
  {
    num: "03",
    role: "דליוורי",
    tag: "DELIVERY",
    value:
      "מוודא שהכל עומד בסטנדרטים. משקף לכם את האמת תמיד, ומוודא שאתם מקבלים את הפתרון האיכותי ביותר.",
  },
] as const;
